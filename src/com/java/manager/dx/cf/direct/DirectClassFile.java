...
package com.java.manager.dx.cf.direct;
...
public class DirectClassFile extends com.android.dx.cf.direct.DirectClassFile implements ClassFile{
    ...
    private void parse0() {
        ...
        com.java.manager.dx.cf.direct.FieldListParser flParser =
            new com.java.manager.dx.cf.direct.FieldListParser(this, thisClass, at, attributeFactory);
        flParser.setObserver(observer);
        fields = flParser.getList();
        at = flParser.getEndOffset();

        com.java.manager.dx.cf.direct.MethodListParser mlParser =
            new com.java.manager.dx.cf.direct.MethodListParser(this, thisClass, at, attributeFactory);
        mlParser.setObserver(observer);
        methods = mlParser.getList();
        at = mlParser.getEndOffset();

        com.java.manager.dx.cf.direct.AttributeListParser alParser =
            new com.java.manager.dx.cf.direct.AttributeListParser(this, AttributeFactory.CTX_CLASS, at,
                                    attributeFactory);
